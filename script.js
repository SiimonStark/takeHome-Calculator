...
class Calculator {
  ...
  divide(n1, n2) {
    if(!n1 || !n2) { // Can also be achieved with (n1===0||n2===0)
      return NaN
    } else {
      return n1 / n2;
    }
...
// let string = Object.prototype.toString.call( calc1 );
console.log(Object.prototype.toString.call( calc1 ));
...
describe( "ScientificCalculator", function(){
  ...
  it( "should provide a string description", function(){
    expect( Object.prototype.toString.call( calculator ) ).to.equal( "[object ScientificCalculator]" );
  } );
} );
